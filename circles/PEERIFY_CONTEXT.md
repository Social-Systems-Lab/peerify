...
23. **Distance-tiered pledge needs (Tier 3, not yet scoped, 2026-08-31).** Explicitly flagged as needing a combined design session with the already-deferred location-based/tiered booking fees item (item 14 above) — not to be scoped independently of it.
24. **"My Pledges" personal inventory page for fans (not yet scoped, 2026-08-31).** A page listing a fan's own pledges across artists. Phased: build a flat list first; richer features (editing, status tracking, etc.) only if usage justifies it.
