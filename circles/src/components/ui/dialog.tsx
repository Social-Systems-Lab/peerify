...
>(({ className, children, hideClose, ...props }, ref) => (
    <DialogPortal>
        ...
        >
            {children}
            {/* hideClose: lets a consumer render its own close control (e.g. a differently-styled
                one placed deliberately relative to other header actions) instead of this default —
                opt-in only, so every other Dialog in the app keeps this exact close as-is. */}
            {!hideClose && (
